...
from evaluator_strategies.InstructBlipModels import InstructBlipAnswerByRephrasing,IntructBlipEvalByHub
...
def main():
    evaluator = IntructBlipEvalByHub(root_dir="./data", device="cuda", names=["new_1","new_2","new_3","new_4"])
