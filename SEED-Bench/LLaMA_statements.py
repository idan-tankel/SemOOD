...
base_prompt = "<s>[INST]\n<<SYS>>\n{system_prompt}\n<</SYS>>\n\n{user_prompt}[/INST]"
base_prompt = """<<SYS>>You are converting a pairs of question-answer about the image into a statement about the image. return a statement which contains information from both the question and answer. Do NOT answer the question. do not give an extra information that is not written.<</SYS>>[INST]User:{text}[/INST]\nAssistant: """
...
save_dir = os.path.join(huggingface_data_dir, "rephrased_single_statement", str(args.question_type_id))
