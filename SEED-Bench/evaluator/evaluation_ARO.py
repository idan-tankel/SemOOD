...
class BLIP2HFModelWrapper:
    ...
    def get_scores_for_captions(self,processed_captions:str, imgs:, batch_size=1):
    ...
    def get_retrieval_scores_batched(self, joint_loader):
        ...
        for batch in tqdm(joint_loader):
            ...
            self.get_scores_for_captions(imgs=imgs,processed_captions=processed_captions, batch_size=batch_size)
