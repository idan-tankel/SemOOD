...
parser.add_argument('--huggingface_data_folder', default='/net/mraid11/export/data/idanta/SEED/SEED-Bench-image')
...
def main():
    ...
    fully_processed_save_dir = f'{args.huggingface_data_folder}/fully_processed_new_fewer_regex/{args.question_type_id}'
